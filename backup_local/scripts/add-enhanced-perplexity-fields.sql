...
-- 
-- IMPORTANT: You must run this script in your database to enable AI enhancement format
-- for Perplexity articles. Copy and paste this into your Supabase SQL Editor or run via psql.

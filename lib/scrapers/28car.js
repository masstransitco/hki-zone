...
async function getBrowserConfig() {
  ...
  try {
    ...
    console.warn('⚠️ @sparticuz/chromium failed, using fallback config:', err.message);
    console.log('🔄 Falling back to puppeteer-core in serverless mode');
    
    // Fallback for serverless environment - use puppeteer-core without chromium
    return {
      headless: true,
      ignoreHTTPSErrors: true,
      args: [
